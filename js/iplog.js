...
// get location 
    ...
    ("http://api.ipinfodb.com/v3/ip-city/?key=/9fddab964eac2d62b1a2979606f49dd363852afca9dadfc880ff51671c97fa88/")

    ip = (".$_SERVER['REMOTE_ADDR']."&format=json)); 
    $country=$url->countryName;  // user country        $city=$url->cityName;       // city
